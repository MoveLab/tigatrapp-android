 ...
 * 
 */
public class ContProvContractReports {

	public ContProvContractReports() {
	}
	...
	public static final class Reports implements BaseColumns {
		 ...
		 * integer. Options are: 0 (report of an adult mosquito), 1 (report of a
		 * mosquito breeding site), and 2 (report from a mission).
		 */
		...
		public static final String[] KEYS_ALL = { KEY_ROW_ID, KEY_USER_ID,
				...
				KEY_CREATION_TIME, KEY_VERSION_TIME, KEY_VERSION_TIME_STRING,
				KEY_TYPE, KEY_CONFIRMATION, KEY_CONFIRMATION_CODE,
				KEY_LOCATION_CHOICE, KEY_CURRENT_LOCATION_LON,
				KEY_CURRENT_LOCATION_LAT, KEY_SELECTED_LOCATION_LON,
				KEY_SELECTED_LOCATION_LAT, KEY_PHOTO_ATTACHED, KEY_PHOTO_URIS,
				KEY_NOTE, KEY_UPLOADED, KEY_SERVER_TIMESTAMP,
				KEY_DELETE_REPORT, KEY_LATEST_VERSION, KEY_PACKAGE_NAME,
				KEY_PACKAGE_VERSION, KEY_PHONE_MANUFACTURER, KEY_PHONE_MODEL,
				KEY_OS, KEY_OS_VERSION, KEY_OS_LANGUAGE, KEY_APP_LANGUAGE,
				KEY_VERSION_UUID, KEY_MISSION_ID };
