...
public class MissionAdapter extends BaseAdapter implements OnClickListener {
	...
	private MissionItemModel tempValues = null;
	int i = 0;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (data.size() <= 0) {
			...
			ArrayAdapter<String> choicesAdapter = new ArrayAdapter<>(activity, android.R.layout.simple_spinner_item,
					tempValues.getItemChoices());
			choicesAdapter.setDropDownViewResource(R.layout.multiline_spinner_dropdown_item);
