...
public class SwitchboardActionBar extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (PropertyHolder.getLanguage() == null) {
			...
			Intent i2l = new Intent(SwitchboardActionBar.this, LanguageSelector.class);
			startActivity(i2l);
			finish();
		} else {
			res = getResources();
			...
			if (!PropertyHolder.hasConsented()) {
				Intent i2c = new Intent(SwitchboardActionBar.this, Consent.class);
				startActivity(i2c);
				finish();
				...
				reportButtonAdult
						.setOnClickListener(new View.OnClickListener() {
							...
							public void onClick(View v) {
								...
								Intent i = new Intent(SwitchboardActionBar.this,
										ReportTool.class);
								Bundle b = new Bundle();
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case (R.id.tigatrappNews): {
			...
			Intent i = new Intent(SwitchboardActionBar.this, RSSActivity.class);
		...
		case (R.id.taskList): {
			...
			Intent i = new Intent(SwitchboardActionBar.this, TaskListActivity.class);
			startActivity(i);
			return true;
		}
		...
		case (R.id.help): {
			...
			Intent i = new Intent(SwitchboardActionBar.this, Help.class);
			startActivity(i);
			return true;
		}
		...
		case (R.id.about): {
			...
			Intent i = new Intent(SwitchboardActionBar.this, About.class);
			startActivity(i);
			return true;
		}
